...
export async function submitForm(formData) {
    try {
        ...
        const url = 'http://localhost:3000/api/peoplemessage';
        const response = await fetch(url, {
            cache: 'no-cache',
            method: 'post',
            headers: {
        ...
        console.log(error)
        return { message: "An Unexpected Error Occured While Making Request To Submit The People Message", status: false }
    }
};
