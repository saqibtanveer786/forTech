...
export async function getAuthorsData(id) {
    try {
        ...
        if (response.ok) {
            ...
            return { message: "Error while making request to author and related posts" }
        }
    } catch (error) {
        console.log("Error is: " + error)
    }
...
export async function submitForm(data) {
    try {
        if (!data.name || !data.email || !data.message) return { message: "Please provide all and correct credentials", status: false }
...
export async function deleteComment(commentId) {
    try {
        ...
        console.log("this errro is where making request to delete comment in server aciton")
        return { message: "something went wrong!", status: 'error' }
    }
}
...
export async function updateComment(commentId, data) {
    try {
        ...
        console.log("this errro is where making request to update comment in server aciton");
        return { message: "something went wrong!", status: 'error' };
    }
}
// Publish a blog
export async function registerAuther(data, id) {
    try {
        ...
        if (response.ok) {
            ...
            jsonresponse = { message: "An Unexpected Error Occured ", status: 'error' }
        }

        return jsonresponse

    } catch (error) {
        return { message: "An Unexpected Error Occured While Making Request To Register Auther", status: false }
    }
}

// Get data for dashboard
export async function getAuthersPostData(id) {
    try {
        const url = `${process.env.HOST}/api/autherposts?userid=${id}`
        const response = await fetch(url, {
            method: 'POST',
            cache: 'no-cache',
            headers: {
        ...
        throw new Error("Error while fetching dashboard data. Error message is :" + error.message)
    }
}
...
export async function addVote(userId, postId, type) {
    try {
        ...
        console.log("Error while fetching while requesting to add vote. Error message is :" + error.message)
