...
import styles from '../../pagesStyles/blogPost.module.css';

// const fetchData = async () => {
//   const response = await fetch(
//     `http://localhost:3000/api/getblog?slug=${searchParams.get('slug')}`,
//     {
//       cache: 'no-cache',
//     }
//   );
...
//   return (
//     <>
//       <section className={styles.blogPostDetail}>
//         <h2>{blogData && blogData.title}</h2>
//         <p>{blogData && blogData.content}</p>
//         {responseStatus ? (
//           <p>
//             Lorem ipsum dolor sit amet consectetur adipisicing elit. Ducimus
//             sequi laborum voluptas quam tempore nostrum provident, iusto eaque
//             consequatur magni nemo eos rerum vitae illum reiciendis molestias
//             fuga modi nobis enim nihil accusamus.
//           </p>
//         ) : (
//           ''
//         )}
...
//             sequi laborum voluptas quam tempore nostrum provident, iusto eaque
//             consequatur magni nemo eos rerum vitae illum reiciendis molestias
//             fuga modi nobis enim nihil accusamus. Totam voluptatibus fuga omnis
//             eius architecto tempora nostrum ducimus corrupti nisi, fugit iure
//             numquam quos magnam quis assumenda explicabo porro libero aspernatur
//             doloribus nulla maxime dicta sint? Distinctio autem incidunt, fuga
//             rerum error facilis in unde animi ratione quae nisi non itaque
//             molestias sapiente corrupti, maxime, doloribus tempora repudiandae
//             quasi! Incidunt quasi velit cupiditate amet, ab vitae quod rem
//             expedita facilis. Non accusantium a, nulla dolorem ratione,
//             dignissimos deserunt amet fuga mollitia quis, corporis expedita
//             modi? Odit, dignissimos corrupti quo exercitationem asperiores rerum
//             eos eius nemo explicabo cupiditate, consequatur aliquid qui, facere
//             quae placeat nihil est. Fugit, delectus repudiandae repellat
//             blanditiis corrupti deleniti nemo ex error? Aspernatur quod
//             excepturi nesciunt ut cupiditate adipisci dolorem fugiat atque
//             laboriosam!
//           </p>
//         ) : (
//           ''
...
export default async function page({ searchParams }) {
  const response = await fetchData(searchParams.slug);
  return (
    <>
      <div class="container mx-auto px-2">
        <section class="grid md:grid-cols-3 mt-12">
          ...
          <main class="col-span-2 relative md:mr-2">
            <h1 class="text-3xl font-bold text-gray-800">For Loops in Javascript</h1>
            ...
            <div class="flex justify-center border">
              <img src="img/aaa.png" class="cursor-pointer" alt="placeholder tag" />
            </div>
            ...
            <article>
              <section>
                <h2 class="text-2xl mb-2 font-semibold font-serif">What is a for loop</h2>
              ...
              <section>
                <h3 class="text-2xl mb-2 font-semibold font-serif">When to Use  a for loop</h3>
              ...
              <section>
                <h3 class="text-2xl mb-2 font-semibold font-serif">How to Use  a for loop</h3>
            ...
            <div id="related-posts" class="grid gap-2">
              ...
              <div class="grid grid-cols-2   border rounded-lg">
                <div class=" md:col-span-2 lg:col-span-1">
                  <img src="img/aaa.png" class="w-full h-auto" />
                </div>
