        ...
        <div className='max-w-[800px] mx-auto'>
            ...
            <ul>
                {comments && comments.length !== 0 && comments.map((comment, i) => {
                    return <article key={i} className="p-6 text-base bg-white rounded-lg relative">
                        <footer className="flex justify-between items-center mb-2">
                            ...
                            {(comment.user?.id === sessionId) && <button
                                ...
                                type="button"
                                onClick={(e) => { e.preventDefault(); setHiddenMenu((previous) => !previous) }}
                            >
                            ...
                            <div id="dropdownComment1"
                                className={`${hiddenMenu ? 'hidden' : ''} absolute right-11 top-12 z-10 w-36 bg-white rounded divide-y divide-gray-100 shadow`}>
