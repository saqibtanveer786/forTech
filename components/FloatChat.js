...
export default function FloatingChat() {
  ...
  const { setAlertMessage, setShowAlert, setAlertStatus } =
  ...
  return (
    <>
      <div
        id="formm"
        className={`fixed hidden flex-col z-50 bottom-20 right-8 sm:top-auto sm:right-5 sm:left-auto h-[400px] w-[250px] overflow-auto min-h-[600x] sm:h-[600px] sm:w-[400px] border border-gray-300 bg-white shadow-2xl rounded-md transition-all`}
      >
        {/* Header */}
        <div className="flex p-5 flex-col justify-center items-center h-32 bg-primary">
          <h3 className="text-lg text-white">How can we help?</h3>
          <p className="text-white opacity-50">
            We will response you soon In Sha Allah
          </p>
        </div>
        ...
        <div className="bg-gray-50 flex-grow p-6">
          <form action={submitHandler}>
            ...
            <div className="mb-4">
              ...
              />
              <div className="empty-feedback invalid-feedback text-red-400 text-sm mt-1 hidden">
